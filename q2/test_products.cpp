...
int main()
{
	...
	date maturityDate11(2022, Dec, 6);
	Future euroDollarFuture("34255233", EuroDollarFuture, "EuroDollar", maturityDate11);

	// Create the bond future
	date maturityDate22(2022, Dec, 7);
	Future bondFuture("98278754", BondFuture, "10Y18765", maturityDate22);
	...
	Future future = futureProductService->GetData("34255233");
	...
	future = futureProductService->GetData("98278754");
	cout << "ID: " << future.GetProductId() << " ==> " << future << endl;
